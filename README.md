# FilePulse 简介，2.18.2 正式版发布，不需要转义，正式原生支持Windows、Mac、Linux同时支持x86_64和aarch64双架构，不同操作系统的版本功能完全一样。由于加壳，杀毒可能误报，请杀毒软件添加信任，媒体测试可以申请无壳版本。
...
| 测试项目                            | FilePulse 2.18.2 (自带统计文件夹大小和扩展名索引)                                                       | Everything 1.4.1.1026+统计文件夹大小+扩展名索引 | Everything1.5.0.1391a+统计文件夹大小+扩展名索引        |
|---------------------------------|-----------------------------------------------------------------------------------------------|-------------------------------------|--------------------------------------------|
...
| 测试项目                          | FilePulse 2.18.2                                                                                    | Anytxt 1.3.2477                   |
|-------------------------------|----------------------------------------------------------------------------------------------------|-----------------------------------|
