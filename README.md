...
在未超频 **7900x + DDR5 + M.2 PCIe 4.0 固态硬盘** 及 **Windows 11** 系统下，FilePulse 可以实现：
...
|--------------------------------|----------------------------------------|-----------------------|-----------------------|
| 220万文件扫描全盘速度+构建存储结构速度          | <span style="color: red;">2.82秒</span> | 7.176秒                | 3.63秒                 |
...
| 支持协议                           | HTTP2/HTTP3                            | HTTP1.0               | HTTP1.0               |
