# FilePulse 简介，1.1.0 正式版发布，由于加壳，杀毒可能误报，请杀毒软件添加信任，媒体测试可以申请无壳版本。
...
- 核心功能4：启动器面板类似音速启动，提前将常用软件进行添加（由于采用浏览器，所以拖拽无法获得完整路径，目前需要输入，未来打造原生应用则可使用拖拽）
- 核心功能5：集群组网使用核心功能1到3（启动面板没必要在集群上使用）
